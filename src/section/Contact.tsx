/**
 * Archivo: Contact.tsx
 * Sirve para: renderizar la sección de contacto.
 * Consejo: empieza con estructura simple (título + bloque) y luego añade formulario por pasos.
 */
import { ChevronDownIcon } from '@heroicons/react/16/solid'

export default function Contact() {
  return (
    <section id="contacto" className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 scroll-mt-16">
      <div
        aria-hidden="true"
